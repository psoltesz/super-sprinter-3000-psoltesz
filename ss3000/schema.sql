...
Then ensure the program finds a possible interview date based on the availability of mentors (using the InterviewSlot model)
  ...
  And reserves the selected interview slot of the mentor, so others cannot re-reserve it (and cause conflict).',	'1000', '4.5', 'In progress');
...
Then ensure the program displays the status of the application (new/in progress/accepted/rejected)
  And ensure the program displays the name of the school.', '700', '2', 'Done');
...
Then ensure the program displays the date/time of the interview
  ...
  And ensure the program displays the name of the mentor.', '700', '3', 'In progress');
...
Then ensure the program displays the questions of the user
  ...
  And ensure the program displays the answers by questions if there is any.', '600', '3.5', 'In progress');
...
Then ensure the program displays the applicants (with all the data from the filters)
  ...
  - by school
  - by mentor name (through interview).', '800', '12.5', 'Planning');
...
Then ensure the user can assign a mentor who will be responsible to answer that question
  And ensure it changes the status of the question (from ""new"" to ""waiting for answer"")', '600', '10', 'Planning');
...
Then ensure the program displays the scheduled interviews with all the following data:
  - date/time
  - application code
  - applicant name.', '400', '10', 'Planning');
...
Then ensure the user can answer the question with some text
  And ensure it changes the status of the question (from ""waiting for answer"" to ""answered"")', '600', '10', 'Planning');
...
- using the developers Gmail accounts for the SMTP configuration', '1000', '10', 'Planning');
...
- using the developers Gmail accounts for the SMTP configuration', '500', '10', 'Planning');
...
- with modifying all the related UI to display all the mentors interviewing', '800', '10', 'Planning');
COMMIT;
